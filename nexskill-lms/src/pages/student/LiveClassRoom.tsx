  ...
  return (
    <StudentAppLayout>
      <div className="max-w-5xl mx-auto px-8 py-8">
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <span className="px-3 py-1 bg-red-100 text-red-600 text-sm font-semibold rounded-full flex items-center gap-2">
        ...
        {/* Join Meeting Card */}
        <div className="bg-gradient-to-br from-brand-primary to-blue-700 rounded-xl p-8 mb-8 text-white">
            ...
            <div>
              ...
              <div className="space-y-2 mb-6">
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <span className="font-mono bg-white/20 px-3 py-1 rounded">{classData.meetingId}</span>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <span className="font-semibold">Passcode:</span>
                  <span className="font-mono bg-white/20 px-3 py-1 rounded">{classData.passcode}</span>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* About This Class */}
            <div className="bg-white rounded-xl p-6 border border-[#EDF0FB]">
